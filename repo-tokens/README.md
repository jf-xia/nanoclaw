...
The badge color reflects what percentage of an LLM context window the codebase fills (context window size is configurable and defaults to 200k tokens). Green for under 30%, yellow-green for 30%-50%, yellow for 50%-70%, red for 70%+.

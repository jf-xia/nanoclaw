...
- **Skills** (`.copilot/skills/`): unlikely to conflict unless you edited an upstream skill
...
- **Skills** (`.copilot/skills/`): unlikely to conflict unless the user edited an upstream skill
...
- Use AskUserQuestion to ask the user which migration skills they want to run now. Options:
  - One option per referenced skill (e.g., "Run /add-telegram to re-apply Telegram channel changes")
...
Send diagnostics data by following `.copilot/skills/update-nanoclaw/diagnostics.md`.

...
description: Add image vision to NanoClaw agents. Resizes and processes WhatsApp image attachments, then sends them to Copilot as multimodal content blocks.
---

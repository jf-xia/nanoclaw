...
This skill adds a stdio-based MCP server that exposes local Ollama models as tools for the container agent. Copilot remains the orchestrator but can offload work to local models.
...
- `[OLLAMA]` log surfacing in `src/agent-runtime.ts`
